...
export default function Footer() {
  ...
  const categories = [
    ...
    { name: 'Smart Devices', path: '/category/smart-devices' },
    { name: 'Services', path: '/category/services' },
    { name: 'Phone Repair', path: '/category/phone-repair' },
    { name: 'Software Installation', path: '/category/software-installation' },
  ];
      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://wa.me/254712345678" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="WhatsApp">
        ...
        <div className="footer-payments">
          ...
          <div className="payment-icons">
            ...
            <span className="payment-icon">Airtel Money</span>
          </div>
        </div>

        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} SMARTP KENYA. All Rights Reserved.</p>
