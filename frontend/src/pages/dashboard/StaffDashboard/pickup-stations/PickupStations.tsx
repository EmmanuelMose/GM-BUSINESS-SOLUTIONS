...
export default function StaffPickupStations() {
  ...
  return (
    <div className="pickup-page">
      ...
      <div className="pickup-header">
        ...
        <Link to="/staff/pickup-stations/create" className="btn-primary">
            ...
            {filteredStations.length === 0 ? (
              <tr>
                <td colSpan={7} className="pickup-empty">
                  ...
                  <Link to="/staff/pickup-stations/create" className="btn-primary btn-sm">Add your first station</Link>
                </td>
              </tr>
            ) : (
              filteredStations.map((station) => (
                <tr key={station.stationId} className={station.isActive ? '' : 'inactive-row'}>
                  ...
                  <td className="pickup-actions">
                    <Link to={`/staff/pickup-stations/edit/${station.stationId}`} className="action-btn edit" title="Edit">
                      <Edit size={16} />
                    </Link>
                    <button
