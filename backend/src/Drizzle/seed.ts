...
async function seed() {
  ...
  const insertedLogs = await db.insert(adminActivityLogs).values([
    {
    ...
    },
    {
      ...
      details: { productId: 1, productName: 'iPhone 15 Pro Max' },
      ipAddress: '192.168.1.1'
    },
    {
      userId: insertedUsers[3].userId,
      action: 'ORDER_UPDATED',
      details: { orderId: 1, status: 'confirmed' },
      ipAddress: '192.168.1.2'
    },
    {
      userId: insertedUsers[0].userId,
      action: 'USER_ROLE_CHANGED',
      details: { userId: 5, oldRole: 'customer', newRole: 'admin' },
      ipAddress: '192.168.1.1'
    },
    {
      userId: insertedUsers[3].userId,
      action: 'PRODUCT_UPDATED',
      details: { productId: 2, field: 'price', oldValue: 30000, newValue: 34500 },
      ipAddress: '192.168.1.2'
    }
  ]).returning();

  console.log(`Inserted ${insertedLogs.length} admin activity logs`);
  ...
  const insertedCategories = await db.insert(categories).values([
    {
      ...
      icon: '📱',
      photo: 'https://example.com/images/mobile-phones.jpg',
      displayOrder: 1,
      isActive: true
    },
    {
      ...
      icon: '🎧',
      photo: 'https://example.com/images/audio-devices.jpg',
      displayOrder: 2,
      isActive: true
    },
    {
      name: 'Television Products',
      slug: 'television-products',
      description: 'Smart TVs and accessories',
      icon: '📺',
      photo: 'https://example.com/images/tvs.jpg',
      displayOrder: 3,
      isActive: true
    },
    {
      ...
      icon: '💻',
      photo: 'https://example.com/images/computers.jpg',
      displayOrder: 4,
      isActive: true
    },
    {
      ...
      icon: '☀️',
      photo: 'https://example.com/images/solar.jpg',
      displayOrder: 5,
      isActive: true
    }
  ]).returning();
  ...
  const insertedAddresses = await db.insert(addresses).values([
    {
      ...
      pickupStation: 'Naoja Ventures - Kakamega Main',
      pickupStationAddress: 'Fortify kakamega station Ayuku house, ground floor, Room No. 2',
      pickupStationPhone: '0704812343',
    ...
    },
    {
      ...
      pickupStation: 'Naoja Ventures - Nairobi CBD',
      pickupStationAddress: 'Moi Avenue, Nairobi',
      pickupStationPhone: '0704812346',
    ...
    },
    {
      ...
      pickupStation: 'Naoja Ventures - Westlands',
      pickupStationAddress: 'Westlands Road, Nairobi',
      pickupStationPhone: '0704812347',
    ...
    },
    {
      ...
      pickupStation: 'Naoja Ventures - Lurambi',
      pickupStationAddress: 'Opposite Bamboo, Lurambi',
      pickupStationPhone: '0704812345',
    ...
    },
    {
      ...
      pickupStation: 'Naoja Ventures - Kisumu',
      pickupStationAddress: 'Oginga Odinga Road, Kisumu',
      pickupStationPhone: '0704812348',
    ...
    },
    {
      ...
      pickupStation: 'Naoja Ventures - Nakuru',
      pickupStationAddress: 'Kenyatta Road, Nakuru',
      pickupStationPhone: '0704812349',
  ...
  const insertedOrders = await db.insert(orders).values([
    {
      ...
      shippingAddress: {
        fullName: 'Jane Smith',
        phone: '0723456789',
        addressLine1: 'Moi Avenue, Nairobi',
        city: 'Nairobi',
        county: 'Nairobi'
      },
      billingAddress: {
    ...
    },
    {
      ...
      shippingAddress: {
        fullName: 'Peter Otieno',
        phone: '0734567890',
        addressLine1: 'Opposite Bamboo, Lurambi',
        city: 'Kakamega',
        county: 'Kakamega'
      },
      billingAddress: {
    ...
    },
    {
      ...
      shippingAddress: {
        fullName: 'Mary Wambui',
        phone: '0745678901',
        addressLine1: 'Oginga Odinga Road, Kisumu',
        city: 'Kisumu',
        county: 'Kisumu'
      },
      billingAddress: {
    ...
    },
    {
      ...
      shippingAddress: {
        fullName: 'David Mwangi',
        phone: '0756789012',
        addressLine1: 'Kenyatta Road, Nakuru',
        city: 'Nakuru',
        county: 'Nakuru'
      },
      billingAddress: {
  ...
  const insertedPayments = await db.insert(payments).values([
    ...
    },
    {
      ...
      paymentResponse: { status: 'success', message: 'Bank transfer confirmed' }
    },
    {
  ...
  const insertedOrderItems = await db.insert(orderItems).values([
    {
      orderId: insertedOrders[0].orderId,
  ...
  const insertedReviews = await db.insert(reviews).values([
    {
      userId: insertedUsers[1].userId,
      productId: insertedProducts[0].productId,
      orderId: insertedOrders[1].orderId,
      ...
      comment: 'Genuine product and fast delivery in Kakamega.',
      status: 'approved',
      photos: ['https://example.com/images/review1.jpg'],
      isVerified: true
    },
    {
      userId: insertedUsers[2].userId,
    ...
    },
    {
      ...
      status: 'pending',
      photos: ['https://example.com/images/review2.jpg', 'https://example.com/images/review3.jpg'],
      isVerified: true
    },
    {
      userId: insertedUsers[4].userId,
      ...
      comment: 'Decent headphones but battery life could be better.',
      status: 'approved',
      photos: [],
      isVerified: false
    },
    {
      ...
      orderId: insertedOrders[0].orderId,
      rating: 4,
      title: 'Good ANC earbuds',
      comment: 'Noise cancellation works well for the price.',
      status: 'pending',
      photos: ['https://example.com/images/review4.jpg'],
      isVerified: true
    }
  ]).returning();
  ...
  const insertedInquiries = await db.insert(inquiries).values([
    {
      name: 'Francis Mwangi',
    ...
    },
    {
      ...
      message: 'Is the iPhone 15 Pro Max available in store? I want to pick it up today.',
      status: 'replied',
      userId: insertedUsers[0].userId,
      productId: insertedProducts[0].productId,
      adminResponse: 'Yes, we have stock available. You can pick up from our Kakamega store.',
    ...
    },
    {
      ...
      message: 'How long does delivery take to Kisumu?',
      status: 'resolved',
      userId: insertedUsers[3].userId,
      productId: null,
      adminResponse: 'Delivery to Kisumu takes 1-2 business days.',
    ...
    },
    {
      ...
      message: 'I need help setting up my new laptop. Can I get a call?',
      status: 'unread',
      userId: insertedUsers[2].userId,
      productId: insertedProducts[4].productId
    }
  ...
  console.log(`Inserted ${insertedInquiries.length} inquiries`);

  const insertedSubscribers = await db.insert(subscribers).values([
    {
  ...
  const insertedCoupons = await db.insert(coupons).values([
    {
      code: 'WELCOME10',
    ...
    {
      code: 'SUMMER20',
      description: '20% off on audio devices',
      discountType: 'percentage',
      discountValue: '20',
      minOrderAmount: '5000',
      maxDiscount: '10000',
      ...
      isActive: true,
      appliesTo: ['categories', [2]]
    },
    {
      code: 'SAVE500',
      description: 'KSh 500 off on any order',
      discountType: 'fixed',
      discountValue: '500',
      minOrderAmount: '2500',
      maxDiscount: null,
    ...
    {
      code: 'VIP1000',
      description: 'KSh 1000 off for VIP customers',
      discountType: 'fixed',
      discountValue: '1000',
      minOrderAmount: '10000',
      maxDiscount: null,
  ...
  const insertedSessions = await db.insert(sessions).values([
    ...
    {
      sessionToken: 'sess_0987654321fedcba',
      userId: insertedUsers[2].userId,
    ...
    {
      sessionToken: 'sess_fedcba0987654321',
      userId: insertedUsers[3].userId,
    ...
    {
      sessionToken: 'sess_12345abcde67890',
      userId: insertedUsers[4].userId,
